...
// ---------------------------------------------------------------------------
bool __fastcall TPreMonta2::InsereSec_Barra(sdi_BARRA_BT &sdi)
{
...
// ---------------------------------------------------------------------------
bool __fastcall TPreMonta2::InsereSec_Capacitor(sdi_CAPACITOR_BT &sdi)
{
	// variáveis locais
	strCAPACITOR str;
...
// ---------------------------------------------------------------------------
bool __fastcall TPreMonta2::InsereSec_Consumidor(sdi_CONS_BT &sdi)
{
	// variáveis locais
	TPtoCargaBT *ptc;
	VTCarga *carga;
...
// ---------------------------------------------------------------------------
bool __fastcall TPreMonta2::InsereSec_ConsIP(sdi_CONS_IP &sdi)
{
	// variáveis locais
	VTBarra *barra;
	VTCarga *carga = NULL;
...
// ---------------------------------------------------------------------------
bool __fastcall TPreMonta2::InsereSec_Gerador(sdi_GERADOR_BT &sdi)
{
	// variáveis locais
...
// ---------------------------------------------------------------------------
bool __fastcall TPreMonta2::InsereSec_Link(sdi_LINK_BT &sdi)
{
	// nada a fazer
	return (true);
}
...
// ---------------------------------------------------------------------------
bool __fastcall TPreMonta2::InsereSec_PtoCarga(sdi_PCARGA_BT &sdi)
{
	// nada a fazer
	return (true);
}
...
// ---------------------------------------------------------------------------
bool __fastcall TPreMonta2::InsereSec_Rede(sdi_INSTAL_TRAFO &sdi)
{
	// variáveis locais
	strREDE str_rede;
	...
	{ // configura Log
		...
		// define fases da Barra iguais às fase do secundário da ET
		// barra_bt->Obj = (TObject*)et->trafo.sec_fases;
		return true;
	}
	catch (Exception &e)
	{
...
// ---------------------------------------------------------------------------
bool __fastcall TPreMonta2::InsereSec_Trecho(sdi_TRECHO_BT &sdi)
{
	// nada a fazer
	return (true);
}
